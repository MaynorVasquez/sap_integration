...
// frappe.ui.form.on("Sincronizacion person sales SAP", {
// 	refresh(frm) {
...
frappe.ui.form.on('Sincronizacion person sales SAP', {
    refresh: function(frm) {
        frm.add_custom_button('Sincronizar vendedores SAP', function() {
            ...
            // Llamada al backend
            frappe.call({
                method: "sap_integration.api.sap_vendedores.sincronizar_lista_vendedores",
                args: {
