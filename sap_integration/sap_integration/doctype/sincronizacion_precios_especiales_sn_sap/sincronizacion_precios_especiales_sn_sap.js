...
// frappe.ui.form.on("Sincronizacion Precios Especiales SN SAP", {
// 	refresh(frm) {
...
frappe.ui.form.on('Sincronizacion Precios Especiales SN SAP', {
    refresh: function(frm) {
        frm.add_custom_button('Sincronizar precios especiales', function() {
            ...
            // Llamada al backend
            frappe.call({
                method: "sap_integration.api.sap_precios_especiales_sn.sincronizar_precios_especiales_sn",
                args: {
