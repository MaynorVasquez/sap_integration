...
// frappe.ui.form.on("Sincronizacion Almacenes SAP", {
// 	refresh(frm) {
...
frappe.ui.form.on('Sincronizacion Almacenes SAP', {
    refresh: function(frm) {
        frm.add_custom_button('Sincronizar Almacenes SAP', function() {
            ...
            // Llamada al backend
            frappe.call({
                method: "sap_integration.api.sap_almacenes.sincronizar_lista_alamacenes",
                args: {
