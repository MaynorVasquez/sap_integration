...
def procesar_datos(lista_vendedor, mapeo_lista, doctype):
    ...
    try:
        ...
        if vendedor_existente:
            ...
            return f"{sap_id} (actualizado) {vendedor_existente}"
        else:
            # Crea Vendedor Nuevo
